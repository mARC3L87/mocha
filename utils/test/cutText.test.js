...
describe('CutText', () => {
  it('should return error if "content" arg is not a string', () => {
  ...
  it('should return error if "content" arg length is 0', () => {
    expect(cutText('', 20)).to.equal('Error');
  });

  it('should return error if "maxLength" is not a number', () => {
  ...
  it('should return error if "maxLength" is lower or equal 0', () => {
  ...
  it('should return cut "content" if proper args', () => {
